...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ViewController *mainVC=[self.window.rootViewController.storyboard instantiateInitialViewController];
...
//    sideMenu.backgroundImage = [UIImage imageNamed:@"bg_night_sunny"];
